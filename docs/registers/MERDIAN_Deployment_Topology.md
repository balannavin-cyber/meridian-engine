...
| Scheduler | Windows Task Scheduler (19 `MERDIAN_*` tasks per Session 29 audit; was 17 at S23) | crontab (6 entries — see §7.1) | crontab (Kite token refresh schedule) |
...
### 7.2 Windows Task Scheduler (19 entries — Session 29 audit, 2026-05-14)
