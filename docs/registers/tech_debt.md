...
| **Related** | ADR-016 PROPOSED (parent decision), ENH-83 (target build), ENH-81 (views consuming τ), D.19.1 (minimum-sufficient-statistic at write layer / derivations in views). |
