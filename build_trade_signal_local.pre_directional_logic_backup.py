...
def _build_signal(symbol: str) -> Dict[str, Any]:
    ...
    direction_bias = _direction_from_gamma(gamma_regime, breadth_regime)
    ...
    if gamma_regime != "SHORT_GAMMA":
        trade_allowed = False
        cautions.append("Directional options-buy signals are disabled outside SHORT_GAMMA")
    ...
    if not breadth_aligned:
        trade_allowed = False
        cautions.append("Gamma and breadth are not aligned")
