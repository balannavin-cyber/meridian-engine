...
def _fetch_latest_momentum_row(sb: SupabaseClient, symbol: str) -> Optional[Dict[str, Any]]:
    return _select_latest_one(
        sb,
...
def _fetch_latest_breadth_row(sb: SupabaseClient) -> Optional[Dict[str, Any]]:
    row = _select_latest_one(
        sb,
...
def main() -> None:
    ...
    breadth_row = _fetch_latest_breadth_row(sb)
    momentum_row = _fetch_latest_momentum_row(sb, symbol)
